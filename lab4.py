...
while 1:  # цикл на проверку однородности дисперсии
    ...
    b23 = numerator_b23 / denominator
    b123 = numerator_b123 / denominator

    print("b\u2080:", "%.2f" % b0, " b\u2081:", "%.2f" % b1, " b\u2082:", "%.2f" % b2, " b\u2083:", "%.2f" % b3, " b\u2081\u2082:", "%.2f" % b12,
          " b\u2081\u2083:", "%.2f" % b13," b\u2082\u2083:", "%.2f" % b23, " b\u2081\u2082\u2083:", "%.2f" % b123)

    print(
        f"Рівняння регресії: y = {b0:.2f}{b1:+.2f}*x\u2081{b2:+.2f}*x\u2082{b3:+.2f}*x\u2083{b12:+.2f}*x\u2081\u2082{b13:+.2f}*x\u2081\u2083{b23:+.2f}*x\u2082\u2083{b123:+.2f}*x\u2081\u2082\u2083")
...
for i in range(N):
    y_hat.append(
        ...
        b13 * x_matrix[i][0] * x_matrix[i][2] +b23 * x_matrix[i][1] * x_matrix[i][2]+ b123 * x_matrix[i][0] * x_matrix[i][1] * x_matrix[i][2])
